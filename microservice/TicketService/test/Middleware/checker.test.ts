...
import { expressAuthChecker } from '../../src/ticket/checker';
...
it('returns false and hits catch block for enforcer on fetch error', async () => {
  global.fetch = vi.fn(() => {
    throw new Error('Network error inside enforcer check');
  }) as any;
